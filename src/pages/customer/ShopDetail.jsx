...
export default function ShopDetail() {
    ...
    return (
        <div className="bg-gray-50 min-h-screen py-8 md:py-12">
                ...
                <div className="bg-white rounded-[2.5rem] p-6 sm:p-10 shadow-sm border border-gray-100 overflow-hidden relative">
                    ...
                    <div className="relative z-10 md:flex justify-between items-center gap-8">
                        ...
                        <div className="flex gap-4 mt-8 md:mt-0 justify-center">
                            <button className="w-14 h-14 rounded-2xl bg-gray-50 text-gray-400 hover:bg-primary-50 hover:text-primary-600 transition-all border border-gray-100 flex items-center justify-center shadow-sm">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
                        {filteredProducts.map((product) => (
                            ...
                            >
                                ...
                                <div className="relative overflow-hidden rounded-2xl h-48 mb-6 cursor-pointer bg-gray-50">
                                    <img
                                        src={
                                            product.image_url ||
                                ...
                                <div className="space-y-2 mb-8 cursor-pointer flex-grow px-1">
            ...
            {/* MOBILE STICKY BAR */}
            <div className="fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-md shadow-[0_-8px_30px_rgb(0,0,0,0.04)] p-4 flex justify-between items-center lg:hidden z-50 border-t border-gray-100">
                ...
                <button className="bg-primary-600 text-white px-8 py-3 rounded-2xl font-bold shadow-lg shadow-primary-100 transition-all active:scale-95">
                    View Cart
                </button>
            </div>
        </div>
