...
export default function OrderManagement({ searchQuery = "" }) {
                        ...
                        <div className="flex items-center justify-end gap-2">
                          ...
                          {["pending", "accepted", "ready"].includes(
                            ...
                            <button
                              ...
                              disabled={isUpdating}
                              className="px-4 py-2 bg-red-50 text-red-600 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-red-100 transition-all disabled:opacity-50"
                            >
                              {isUpdating ? "..." : "Cancel"}
                            </button>
                          )}
