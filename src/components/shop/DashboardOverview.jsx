                ...
                <div className="bg-primary-600 rounded-[2.5rem] p-8 text-white relative overflow-hidden shadow-2xl shadow-primary-200">
                    <div className="relative z-10">
                        ...
                        <p className="text-primary-100 text-sm font-medium leading-relaxed mb-6">
                            You've delivered 15% more orders this week compared
                            to last week. Keep it up!
                        </p>
                        <button className="bg-white text-primary-600 px-6 py-2.5 rounded-xl text-xs font-black uppercase tracking-widest hover:bg-primary-50 transition-all">
                            View Reports
                        </button>
                    </div>
                    {/* Decorative Blobs */}
